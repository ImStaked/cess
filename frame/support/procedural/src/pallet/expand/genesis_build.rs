...
///
/// * implement the trait `cessp_runtime::BuildModuleGenesisStorage`
...
pub fn expand_genesis_build(def: &mut Def) -> proc_macro2::TokenStream {
	...
	quote::quote_spanned!(genesis_build.attr_span =>
		#[cfg(feature = "std")]
		impl<#type_impl_gen> #frame_support::cessp_runtime::BuildModuleGenesisStorage<#trait_use_gen>
			for #gen_cfg_ident<#gen_cfg_use_gen> #where_clause
		{
			fn build_module_genesis_storage(
				&self,
				storage: &mut #frame_support::cessp_runtime::Storage,
