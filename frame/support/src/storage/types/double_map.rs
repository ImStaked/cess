...
use cessp_arithmetic::traits::SaturatedConversion;
	...
	MaxValues: Get<Option<u32>>,
{
	...
	pub fn remove_prefix<KArg1>(k1: KArg1, limit: Option<u32>) -> cessp_io::KillStorageResult
	where
	...
	pub fn remove_all(limit: Option<u32>) -> cessp_io::KillStorageResult {
