...
use cessp_runtime::RuntimeDebug;
...
impl cessp_std::cmp::PartialOrd for CrateVersion {
	fn partial_cmp(&self, other: &Self) -> Option<cessp_std::cmp::Ordering> {
		let res = self
			.major
			.cmp(&other.major)
...
impl PartialOrd<u16> for StorageVersion {
	fn partial_cmp(&self, other: &u16) -> Option<cessp_std::cmp::Ordering> {
