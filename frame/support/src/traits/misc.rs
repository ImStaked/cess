...
use cessp_runtime::{traits::Block as BlockT, DispatchError};
...
pub trait Time {
	type Moment: cessp_arithmetic::traits::AtLeast32Bit + Parameter + Default + Copy;
...
pub trait ExtrinsicCall: cessp_runtime::traits::Extrinsic {
	/// Get the call of the extrinsic.
	fn call(&self) -> &Self::Call;
}

#[cfg(feature = "std")]
impl<Call, Extra> ExtrinsicCall for cessp_runtime::testing::TestXt<Call, Extra>
where
...
impl<Address, Call, Signature, Extra> ExtrinsicCall
	for cessp_runtime::generic::UncheckedExtrinsic<Address, Call, Signature, Extra>
where
	Extra: cessp_runtime::traits::SignedExtension,
{
	fn call(&self) -> &Self::Call {
		&self.function
	}
