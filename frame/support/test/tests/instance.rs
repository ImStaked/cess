...
mod module1 {
	...
	#[derive(PartialEq, Eq, Clone, cessp_runtime::RuntimeDebug, Encode, Decode, TypeInfo)]
...
fn new_test_ext() -> cessp_io::TestExternalities {
	GenesisConfig {
...
fn storage_instance_independence() {
	let mut storage = cessp_core::storage::Storage {
