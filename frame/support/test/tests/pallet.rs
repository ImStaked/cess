...
impl frame_system::Config for Runtime {
	...
	type Call = Call;
	type Hash = cessp_runtime::testing::H256;
	type Hashing = cessp_runtime::traits::BlakeTwo256;
	type AccountId = u64;
	type Lookup = cessp_runtime::traits::IdentityLookup<Self::AccountId>;
	type Header = Header;
	type Event = Event;
...
pub type Header = cessp_runtime::generic::Header<u32, cessp_runtime::traits::BlakeTwo256>;
pub type Block = cessp_runtime::generic::Block<Header, UncheckedExtrinsic>;
pub type UncheckedExtrinsic = cessp_runtime::generic::UncheckedExtrinsic<u32, Call, (), ()>;
...
fn migrate_from_pallet_version_to_storage_version() {
	...
	TestExternalities::default().execute_with(|| {
		...
		cessp_io::storage::set(&pallet_version_key(Example::name()), &[1, 2, 3]);
		cessp_io::storage::set(&pallet_version_key(Example2::name()), &[1, 2, 3]);
		cessp_io::storage::set(&pallet_version_key(System::name()), &[1, 2, 3]);
		...
		assert!(cessp_io::storage::get(&pallet_version_key(Example::name())).is_none());
		assert!(cessp_io::storage::get(&pallet_version_key(Example2::name())).is_none());
		assert!(cessp_io::storage::get(&pallet_version_key(System::name())).is_none());
