...
/// An implementation of `cessp_runtime::traits::Block` to be used in tests.
pub type MockBlock<T> = generic::Block<
	generic::Header<<T as crate::Config>::BlockNumber, cessp_runtime::traits::BlakeTwo256>,
