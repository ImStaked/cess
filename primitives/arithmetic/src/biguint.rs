...
use cessp_std::{cell::RefCell, cmp::Ordering, convert::TryFrom, ops, prelude::*, vec};
...
static_assertions::const_assert!(
	cessp_std::mem::size_of::<Double>() - cessp_std::mem::size_of::<Single>() == SHIFT / 8
);
...
impl cessp_std::fmt::Debug for BigUint {
	#[cfg(feature = "std")]
	...
	#[cfg(not(feature = "std"))]
	fn fmt(&self, _: &mut cessp_std::fmt::Formatter<'_>) -> cessp_std::fmt::Result {
		Ok(())
	}
}
