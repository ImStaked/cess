...
//! ```
//! use codec::Decode;
//! use cessp_inherents::{InherentIdentifier, InherentData};
//!
...
//! 		mut error: &[u8],
//! 	) -> Option<Result<(), cessp_inherents::Error>> {
...
//! 		Some(Err(
//! 			cessp_inherents::Error::Application(Box::from(String::decode(&mut error).ok()?))
//! 		))
//! 	}
//! }
//! ```
...
//!
//! ```
//! # use cessp_runtime::testing::ExtrinsicWrapper;
//! # use cessp_inherents::{InherentIdentifier, InherentData};
//! # use futures::FutureExt;
//! # type Block = cessp_runtime::testing::Block<ExtrinsicWrapper<()>>;
//! # const INHERENT_IDENTIFIER: InherentIdentifier = *b"testinh0";
//! # struct InherentDataProvider;
//! # #[async_trait::async_trait]
//! # impl cessp_inherents::InherentDataProvider for InherentDataProvider {
//! # 	fn provide_inherent_data(&self, inherent_data: &mut InherentData) -> Result<(), cessp_inherents::Error> {
//! # 		inherent_data.put_data(INHERENT_IDENTIFIER, &"hello")
//! # 	}
//! # 	async fn try_handle_error(
//! # 		&self,
...
//! 	_: impl cessp_inherents::CreateInherentDataProviders<Block, ()>,
//! ) {
//! 	// do cool stuff
//! }
//!
