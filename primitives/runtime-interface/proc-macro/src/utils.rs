...
pub fn generate_runtime_interface_include() -> TokenStream {
	match crate_name("cessp-runtime-interface") {
...
/// Generates the access to the `cessp-runtime-interface` crate.
pub fn generate_crate_access() -> TokenStream {
	if env::var("CARGO_PKG_NAME").unwrap() == "cessp-runtime-interface" {
