...
use cessp_core::U256;
use cessp_std::{convert::TryFrom, fmt::Debug};

/// Abstraction over a block header for a substrate chain.
#[derive(Encode, Decode, PartialEq, Eq, Clone, cessp_core::RuntimeDebug, TypeInfo)]
...
where
	...
	Hash: HashT,
	Hash::Output:
		Default + cessp_std::hash::Hash + Copy + Member + MaybeDisplay + SimpleBitOps + Codec,
{
