...
#[derive(PartialEq, cessp_runtime::RuntimeDebug)]
...
impl cessp_runtime::traits::Printable for OffenceError {
	fn print(&self) {
		"OffenceError".print();
		match self {
...
#[derive(Clone, PartialEq, Eq, Encode, Decode, cessp_runtime::RuntimeDebug, scale_info::TypeInfo)]
