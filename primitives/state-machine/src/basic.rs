...
impl BasicExternalities {
	...
	pub fn execute_with<R>(&mut self, f: impl FnOnce() -> R) -> R {
		cessp_externalities::set_and_run_with_externalities(self, f)
	}
...
impl cessp_externalities::ExtensionStore for BasicExternalities {
	...
	fn register_extension_with_type_id(
		&mut self,
		type_id: TypeId,
		extension: Box<dyn cessp_externalities::Extension>,
