...
use cessp_core::{self, storage::PrefixedStorageKey};
...
pub type Configuration = cessp_core::ChangesTrieConfiguration;
	...
	H::Out: Ord + 'static + Encode,
{
	...
	let is_config_changed =
		match changes.storage(cessp_core::storage::well_known_keys::CHANGES_TRIE_CONFIG) {
