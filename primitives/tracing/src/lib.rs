...
///
/// ```rust
/// cessp_tracing::enter_span!(cessp_tracing::Level::TRACE, "fn wide span");
/// {
/// 		cessp_tracing::enter_span!(cessp_tracing::trace_span!("outer-span"));
/// 		{
/// 			cessp_tracing::enter_span!(cessp_tracing::Level::TRACE, "inner-span");
/// 			// ..
/// 		}  // inner span exists here
/// 	} // outer span exists here
///
/// cessp_tracing::within_span! {
/// 		cessp_tracing::debug_span!("debug-span", you_can_pass="any params");
///     1 + 1;
...
/// use any valid `cessp_tracing::Span`followe by `;` and the code to execute,
///
/// # Example
///
/// ```
/// cessp_tracing::within_span! {
/// 		cessp_tracing::Level::TRACE,
///     "test-span";
///     1 + 1;
///     // some other complex code
/// }
///
/// cessp_tracing::within_span! {
/// 		cessp_tracing::span!(cessp_tracing::Level::WARN, "warn-span", you_can_pass="any params");
///     1 + 1;
///     // some other complex code
/// }
///
...
/// or pass in any valid `cessp_tracing::Span` for extended usage. The span will
...
///
/// ```
/// cessp_tracing::enter_span!(cessp_tracing::Level::TRACE, "test-span");
/// // previous will be dropped here
/// cessp_tracing::enter_span!(
/// 	cessp_tracing::span!(cessp_tracing::Level::DEBUG, "debug-span", params="value"));
/// cessp_tracing::enter_span!(cessp_tracing::info_span!("info-span",  params="value"));
///
/// {
/// 		cessp_tracing::enter_span!(cessp_tracing::Level::TRACE, "outer-span");
/// 		{
/// 			cessp_tracing::enter_span!(cessp_tracing::Level::TRACE, "inner-span");
/// 			// ..
/// 		}  // inner span exists here
