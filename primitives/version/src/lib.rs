...
pub use cessp_runtime::create_runtime_str;
use cessp_runtime::RuntimeString;
#[doc(hidden)]
pub use cessp_std;
...
pub type ApisVec = cessp_std::borrow::Cow<'static, [(ApiId, u32)]>;

/// Create a vector of Api declarations.
#[macro_export]
macro_rules! create_apis_vec {
	( $y:expr ) => {
		$crate::cessp_std::borrow::Cow::Borrowed(&$y)
	};
}
...
/// runtime.
#[derive(Clone, PartialEq, Eq, Encode, Decode, Default, cessp_runtime::RuntimeDebug, TypeInfo)]
