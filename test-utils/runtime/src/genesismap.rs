...
use cessp_io::hashing::{blake2_256, twox_128};
use cessp_runtime::traits::{Block as BlockT, Hash as HashT, Header as HeaderT};
...
pub fn insert_genesis_block(storage: &mut Storage) -> cessp_core::hash::H256 {
